#By @NOOB_GUY_OP for King fighter
...
async def _(event):
    ...
    for i in animation_ttl:#By @NOOB_GUY_OP for King fighter
        	
            await asyncio.sleep(animation_interval)
            await event.edit(animation_chars[i %16 ], link_preview=True)#By @NOOB_GUY_OP for King fighter
